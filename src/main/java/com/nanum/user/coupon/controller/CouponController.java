...
public class CouponController {
    ...
    public ResponseEntity<ApiResponse<Page<CouponDTO.Response>>> getAvailableCoupons(
        ...
        Page<CouponDTO.Response> coupons = couponService.getAvailableCoupons(principal.getName(), siteCd, pageable);
    ...
    public ResponseEntity<ApiResponse<Page<CouponDTO.Response>>> getAllCoupons(
            @RequestParam String siteCd,
            Principal principal, @PageableDefault(size = 10) Pageable pageable) {
        Page<CouponDTO.Response> coupons = couponService.getAllCoupons(principal.getName(), siteCd, pageable);
    ...
    public ResponseEntity<ApiResponse<java.util.List<CouponDTO.DownloadableResponse>>> getDownloadableCoupons(
            @RequestParam String siteCd,
            Principal principal) {
        java.util.List<CouponDTO.DownloadableResponse> coupons = couponService.getDownloadableCoupons(principal.getName(), siteCd);
    ...
    public ResponseEntity<ApiResponse<Void>> downloadCoupon(
            ...
            @RequestParam String siteCd,
            Principal principal) {
        couponService.downloadCoupon(couponId, principal.getName(), siteCd);
